...
const Topbar = ({ view, setView, setIsFiltered, isFiltered }) => {
  ...
  const handleOpenEmployeeModal = (scrollType) => () => {
    setScroll(scrollType);
    setOpenEmployeeModal(true);
  };

  const handleOpenClientModal = (scrollType) => {
    setScroll(scrollType);
  ...
  return (
    <div className="flex flex-col ">
      ...
      <div className="flex justify-between items-center mb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <Tooltip title="Add New Employee" placement="top" arrow>
                <div onClick={handleOpenEmployeeModal("body")}>
        ...
        {showClientTopBar && showCreatePageTopBar && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <Tooltip title="Add New Employee" placement="top" arrow>
                <div onClick={() => handleOpenClientModal("body")}>
                  <button
      ...
      <CreateUser open={openEmployeeModal} scroll={scroll} setOpen={setOpenEmployeeModal} />
      <CreateClientModal open={openClientModal} setOpen={setOpenClientModal} />
