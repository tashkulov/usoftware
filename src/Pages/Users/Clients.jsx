...
import {getClientsReducer, getEmployeesReducer, getUserReducer} from "../../redux/reducer/user";
...
const Clients = () => {
  ...
  const { clients, isFetching, error, loggedUser,allClients } = useSelector((state) => state.user);
  const columns = [
    {
      field: "uid",
      headerName: "ID",
  ...
  return (
    <div className="w-full">
      <EditClientModal open={openEditModal} setOpen={setOpenEditModal} client={selectedClient} />
